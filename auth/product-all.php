...
<tr>
          ...
          <td>2</td>
          <td>
            <a href="product-show.php?id=<?php echo $rows['id']; ?>">Show</a> <a href="cat-update.php?id=<?php echo $rows['id'] ?>">Update</a> <a href="product-delete.php?id=<?php echo $rows['id'] ?>">Deleted</a>
          </td>
          <td>4</td>
          <td>18</td>
          <td>
