                  ...
                  <div class="card-body px-5 pb-5 pt-0">
                    ...
                    <form action="signup-save.php" method="post" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="form-group col-md-12 ">
                          <input type="password" name="password" class="form-control input-lg" id="cpassword" placeholder="Confirm Password">
                        </div>
                        <div class="form-group col-md-12 mb-4">
                          <input type="file" name="userimage" class="form-control input-lg" id="image" aria-describedby="emailHelp" placeholder="userimage">
                        </div>
                        <div class="col-md-12">
